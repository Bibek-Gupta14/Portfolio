...
;
const metadata = {
    title: "Bibek Gupta Resume ",
    description: "Computer Science undergraduate at KIIT with hands-on AI/ML experience. Proficient in DSA, skilled in MERN Stack, and Python-based Machine Learning.",
    generator: "v0.app",
    icons: {
        icon: [
            {
